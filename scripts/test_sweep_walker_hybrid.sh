...
poetry run python3.10 src/active_rlhf/scripts/pref_ppo.py \
  ...
  --variquery-vae-lr=0.001 \
  --variquery-vae-weight-decay=2e-5 \
  --variquery-vae-latent-dim=64 \
  --variquery-vae-hidden-dims "[256, 128, 64]" \
